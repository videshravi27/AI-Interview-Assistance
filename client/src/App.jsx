    ...
    <Provider store={store}>
      ...
      >
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          {/* Header */}
          <header className="bg-white/10 backdrop-blur-md border-b border-white/20 h-20 flex items-center justify-between px-8 sticky top-0 z-40">
            ...
            <div className="flex gap-2 bg-white/20 backdrop-blur-sm rounded-xl p-1">
              <button
                className={`px-6 py-3 text-sm font-semibold rounded-lg transition-all duration-300 ${tab === "Interviewee"
              ...
              <button
                className={`px-6 py-3 text-sm font-semibold rounded-lg transition-all duration-300 ${tab === "Interviewer"
                  ? "bg-white text-purple-800 shadow-lg"
                  : "text-white/80 hover:text-white hover:bg-white/10"
                  }`}
              ...
              <button
                className="px-6 py-3 text-sm font-semibold rounded-lg bg-blue-500 text-white hover:bg-blue-600 transition-all duration-300"
